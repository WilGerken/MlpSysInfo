...
namespace SysInfo.Library.Resources
{
    ...
    {
        public const string SI_SCHEMA_NM  = "Core";

        private const string MANAGER_TYPE_NAME = "SysInfo.Library.Resources.{0}.DalManager, SysInfo_Library";
